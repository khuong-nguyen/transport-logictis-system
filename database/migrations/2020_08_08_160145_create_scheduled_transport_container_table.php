...
class CreateScheduledTransportContainerTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('scheduled_transport_container', function (Blueprint $table) {
            ...
            $table->datetime('inprocess_date')->nullable()->default(NULL);
            $table->datetime('assigned_date')->nullable()->default(NULL);
            $table->datetime('refuse_date')->nullable()->default(NULL);
            ...
            $table->string('schedule_status',20)->default('ASSINGED')->comment('[ASSINGED,INPROCESS,REFUSE,COMPLETED,DELAY,ONTIME,CANCEL]');
