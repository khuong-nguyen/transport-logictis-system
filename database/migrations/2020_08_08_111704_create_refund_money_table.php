...
class CreateRefundMoneyTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('refund_money', function (Blueprint $table) {
            ...
            $table->foreignId('recieve_money_employee_id')->comment('employee_id');
            $table->string('refund_money_employee_code', 30)->comment('employee_code');
            $table->string('recieve_money_employee_code', 30)->comment('employee_code');
            ...
            $table->decimal('refund_money');
            $table->decimal('balance_money');
